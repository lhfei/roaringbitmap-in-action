...
public class CompressionResults {
	...
	public static void testSuperSparse() {
		...
		System.out.println(
				"An uncompressed bitset might use " + F.format(universe_size * 1.0 / howmany) + " bits per value set");
		System.out.println();
	...
	public static void testSuperDense() {
		...
		System.out.println("An uncompressed bitset might use " + F.format(universe_size * 1.0 / r.getCardinality())
				+ " bits per value set");
		System.out.println();
	}
